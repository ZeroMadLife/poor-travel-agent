...
本设计通过用户书面复核后，才能另行编写实施计划。实施计划必须拆分 TargetResolver、
ActivityGuard、PriorityEngine、双夜状态机、权限分类、槽位、通知和 canary，逐项给出测试
与回滚。不得把本设计文档的提交视为 Phase 3 已启用。
