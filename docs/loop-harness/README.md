...
- [Phase 2 实施计划](../superpowers/plans/2026-07-16-sage-loop-engineer-phase2.md)：小版本 1-4 的 shadow 基线已交付
...
- 已实现：`SHADOW_WRITE` 模式、Phase 1 SQLite 迁移、dirty path 避让、只读 Scanner、受控
  Fixer、真实 diff/权限判级、全量前端测试与 build、私有 quota 证据和安全清理；
- 尚未实现：截图、Claude Reviewer、GitHub Draft PR/Issue、PR 槽位和 auto-merge canary；
