...
.message-area { min-height:0; overflow-y:auto; padding:22px clamp(18px,4vw,56px) 32px; scrollbar-gutter:stable; }.message-area > * { width:100%; max-width:1120px; margin-left:auto; margin-right:auto; }
