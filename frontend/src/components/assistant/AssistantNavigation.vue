...
.navigation-brand { display:flex; align-items:center; gap:10px; min-height:42px; padding:0 8px 12px; }.brand-mark { display:grid; place-items:center; width:30px; height:30px; border-radius:var(--sage-radius); color:var(--sage-brand); background:var(--sage-brand-bg); }.navigation-brand > span:last-of-type { display:flex; flex-direction:column; min-width:0; }.navigation-brand strong { font-size:15px; }.navigation-brand small { color:var(--sage-text-muted); font-size:10px; }.navigation-brand button { display:grid; place-items:center; width:32px; height:32px; margin-left:auto; padding:0; border:0; border-radius:var(--sage-radius); color:var(--sage-text-secondary); background:transparent; }
nav { display:flex; flex-direction:column; gap:3px; padding-top:8px; border-top:1px solid var(--sage-border); }nav a,.settings-link { display:flex; align-items:center; gap:10px; min-height:38px; padding:0 10px; border-radius:var(--sage-radius); color:var(--sage-text-secondary); text-decoration:none; font-size:13px; }nav a:hover,.settings-link:hover { color:var(--sage-text); background:var(--sage-surface-muted); }nav a.active { color:var(--sage-brand-strong); background:var(--sage-brand-bg); font-weight:650; }
.navigation-spacer { flex:1; }.knowledge-state { display:flex; align-items:center; gap:9px; margin:0 6px 8px; padding:10px 5px; border-top:1px solid var(--sage-border); }.knowledge-state i { width:8px; height:8px; border-radius:50%; background:var(--sage-review); }.knowledge-state span { display:flex; flex-direction:column; }.knowledge-state strong { color:var(--sage-text-secondary); font-size:11px; }.knowledge-state small { color:var(--sage-text-muted); font-size:10px; }.settings-link { border-top:1px solid var(--sage-border); border-radius:0; }
